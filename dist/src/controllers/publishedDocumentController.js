...
export const getPublishedDocumentByIdController = async (req, res) => {
    try {
        const { id } = req.params;
...
export const searchPublishedDocumentsController = async (req, res) => {
    try {
...
export const getFeaturedArticlesController = async (req, res) => {
    try {
        const feed = await prisma.publishedDocuments.findMany({
